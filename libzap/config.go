...
type PresetConfig struct {
	...
	JSONTimeKey       string              `yaml:"jsonTimeKey"       env:"JSON_TIME_KEY"       env-default:"ts"         env-description:"Set the key used for time log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONLevelKey      string              `yaml:"jsonLevelKey"      env:"JSON_LEVEL_KEY"      env-default:"level"      env-description:"Set the key used for level log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONNameKey       string              `yaml:"jsonNameKey"       env:"JSON_NAME_KEY"       env-default:"logger"     env-description:"Set the key used for name log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONCallerKey     string              `yaml:"jsonCallerKey"     env:"JSON_CALLER_KEY"     env-default:"caller"     env-description:"Set the key used for caller log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONFunctionKey   string              `yaml:"jsonFunctionKey"   env:"JSON_FUNCTION_KEY"   env-default:""           env-description:"Set the key used for function log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONMessageKey    string              `yaml:"jsonMessageKey"    env:"JSON_MESSAGE_KEY"    env-default:"msg"        env-description:"Set the key used for message log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
	JSONStacktraceKey string              `yaml:"jsonStacktraceKey" env:"JSON_STACKTRACE_KEY" env-default:"stacktrace" env-description:"Set the key used for stack trace log entry. JSON: empty key omits the entry. Any encoding: '-' omits the entry."`
